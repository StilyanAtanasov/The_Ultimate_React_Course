export function Star({ onClick, onMouseEnter, onMouseLeave, full, color = "#fcc419", size = 24 }) {
  return (
    <span className="star" onClick={onClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} style={{ width: size, height: size, display: "inline-block", cursor: "pointer" }}>
      {full ? (
